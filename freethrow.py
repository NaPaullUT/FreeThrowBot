...
class FreeThrowEnv(core.Env):
    ...
    def step(self, a):
        ...
        torque = [self.AVAIL_TORQUE[a[0]],self.AVAIL_TORQUE[a[1]]]
        #p = s[4]
        p=self.poss
        p_a = a[2]
    ...
    def _dsdt(self, s_augmented):
        ...
        if(dtheta1==self.MAX_VEL_1 and ddtheta1>0):
            ...
            old = ddtheta1
            ddtheta1=np.median([-2,2,ddtheta1])
        ...
        if(dtheta2==self.MAX_VEL_2 and ddtheta2>0):
            ...
            #print("not max 2")
            ddtheta2=np.median([-2,2,ddtheta2])
    ...
    def render(self, mode="human"):
        ...
        hoop = pygame.Rect(400,int(self.SCREEN_DIM_HEIGHT/2),100,25)
